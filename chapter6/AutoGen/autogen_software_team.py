...
def create_openai_model_client():
    ...
    #         "max_tokens": 64000,  # 最大输出长度：64K tokens
    #         "context_length": 256000,  # 上下文长度：256K tokens
    #         "vision": False,  # 不支持图像
    #         "json_output": True,  # 支持结构化输出（JSON）
    #         "structured_output": True,  # 显式支持结构化输出
    #         "family": "qwen"
    #     }
    # )
    return OpenAIChatCompletionClient(
...
async def run_software_development_team():
    ...
    terminate = TextMentionTermination("TERMINATE")
    print("创建团队聊天...")
